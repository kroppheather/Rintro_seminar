...
###############################################################
#########You will learn some functions that make      #########
#########working with data easier. You will also learn#########
#########how to make your basic plots look nicer.     #########
###############################################################
...
#1. read in data
	...
	#B. set the working directory
		setwd("c:\\Users\\hkropp\\Documents\\GitHub\\Rintro_seminar\\02_working_with_data")
...
#2. Convert dates to day of year
	...
	#A. specify date format
		...
		#m =month
		#d= day
		#Y= year with four digits (2000)
		#y= year with two digits (00)
...
#6. Make a plot of the average thaw depth over time	with each
# stand seperated	
...
#7. Activities to complete on your own:
	...
	#################################
	#calculate each sampling date as 
	#the proportion of the year
	
	#################################
	##Q2. fill in your answer      ##
	#################################
	#plot the average thaw depth for each stand
	#how does the plot differ from your scatter plot?
	
	#################################
	##Q3. fill in your answer      ##
	#################################	
	#what are the differences between tapply and aggregate
	
	#################################
	##Q4. fill in your answer      ##
	#################################	
	# add arrows of the standard deviat
	#to the plot from #6 using arrows() 
	#with the code argument set to zero
